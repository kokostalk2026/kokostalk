...
$stmt = $conexion->prepare("SELECT username, email, country, reason FROM usuarios WHERE id = ?");
...
<div class="account-hero">
    <div class="hero-inner">
      ...
      <div class="hero-info">
            <h1 id="heroName"><?php echo htmlspecialchars($_SESSION['usuario']); ?></h1>
            <p id="heroEmail"><?php echo htmlspecialchars($_SESSION['email']); ?></p>
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            <label>Country</label>
            <input class="form-control" id="inputCountry" type="text" placeholder="El Salvador" value="<?php echo htmlspecialchars($_SESSION['country'] ?? 'El Salvador'); ?>">
        </div>

        <div class="form-group">
            <label>Why are you learning LESSA?</label>
            <input class="form-control" id="inputReason" type="text" placeholder="I find it fascinating..." value="<?php echo htmlspecialchars($_SESSION['reason'] ?? ''); ?>">
        </div>
...
async function saveProfile() {
    ...
    formData.append('username', document.getElementById('inputName').value.trim());
    formData.append('email', document.getElementById('inputEmail').value.trim());
    formData.append('country', document.getElementById('inputCountry').value.trim());
    formData.append('reason', document.getElementById('inputReason').value.trim());
    ...
    try {
        ...
        showToast(data.message || 'Respuesta recibida.');
...
document.addEventListener('DOMContentLoaded', updateProfileProgress);
</script>
